...
oc create -n openshift -f https://raw.githubusercontent.com/johnathonlee/jdv-ose-demos/master/templates/datavirt63-ext-mysql-psql-s2i.json
...
oc create -f https://raw.githubusercontent.com/johnathonlee/jdv-ose-demos/master/dynamicvdb-datafederation/mysql-postgresql-driver-image/datavirt-app-secret.yaml
...
curl https://raw.githubusercontent.com/johnathonlee/jdv-ose-demos/master/dynamicvdb-datafederation/mysql-postgresql-driver-image/datasources.properties -o datasources.properties
